...
void bench(std::vector<uint64_t> &input) {
  ...
  pretty_print(
    volume, volume * sizeof(uint64_t), "C++ std::shuffle (lehmer)",
    bench([&input, &lehmerGenerator]() {
  ...
  pretty_print(
    ...
    bench([&input, &lehmerGenerator]() {
      batched_random::shuffle_2(input.begin(), input.end(), lehmerGenerator);
    },
    min_repeat, min_time_ns, max_repeat)
  );
  
  pretty_print(
    volume, volume * sizeof(uint64_t), "C++ shuffle_2-6 (lehmer)",
    bench([&input, &lehmerGenerator]() {
      batched_random::shuffle_23456(input.begin(), input.end(), lehmerGenerator);
    },
    min_repeat, min_time_ns, max_repeat)
  );
  ...
  pretty_print(
    volume, volume * sizeof(uint64_t), "C++ shuffle 2 (mersenne)",
    bench([&input, &mtGenerator]() {
      batched_random::shuffle_2(input.begin(), input.end(), mtGenerator);
    },
    min_repeat, min_time_ns, max_repeat)
  );
  
  pretty_print(
    volume, volume * sizeof(uint64_t), "C++ shuffle_2-6 (mersenne)",
    bench([&input, &mtGenerator]() {
      batched_random::shuffle_23456(input.begin(), input.end(), mtGenerator);
    },
    min_repeat, min_time_ns, max_repeat)
  );
  ...
  pretty_print(
    volume, volume * sizeof(uint64_t), "standard shuffle (lehmer)",
  ...
  pretty_print(
    volume, volume * sizeof(uint64_t), "standard shuffle (PCG)",
    bench([&input]() { shuffle_pcg(input.data(), input.size()); },
    min_repeat, min_time_ns, max_repeat)
  );
  
  pretty_print(
    volume, volume * sizeof(uint64_t), "batch shuffle 2 (PCG)",
